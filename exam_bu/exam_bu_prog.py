...
class FICheck(QtCore.QState):
    def onEntry(self, QEvent):
        ...
        com.text.setText(f'<p>Установите на программаторе режим <b><font color="blue">"РЕА0"</font></b>. '
                         ...
                         f'Если это условие выполняется нажмите <font color="green">"ПРИНЯТЬ"</font>,'
                         f'<br>Если условие не выполняется нажмите <font color="red">"ВНИЗ"</font>.</p>'
                         )
